...
const Scenes = (() => {
  ...
  const SCENES = [
    {
      ...
      cards: ['rings', 'stats', 'quick', 'list', 'today', 'trends', 'insights'],
      tip: null
    },
    {
      key: 'store',
      ...
      cards: ['rings', 'stats', 'list', 'trends', 'insights'],
    ...
    },
    {
      ...
      cards: ['rings', 'stats', 'list', 'insights', 'trends'],
    ...
    },
    {
      ...
      cards: ['trends', 'insights', 'rings', 'stats', 'list'],
    ...
    },
    {
      ...
      opens: 'home',
      lead: { label: 'Log a meal', nav: 'log' },
      cards: ['rings', 'quick', 'stats', 'list', 'trends'],
  ...
  const ORDERS = {
    ...
    morning: ['rings', 'quick', 'stats', 'list', 'today', 'insights', 'trends'],
    // Mid-day: how much room is left, and what has gone in.
    midday:  ['rings', 'stats', 'list', 'quick', 'today', 'trends', 'insights'],
    // The question the whole app exists for: what can dinner be?
    evening: ['rings', 'stats', 'quick', 'list', 'today', 'insights', 'trends'],
    // Day effectively done: the record and the week.
    night:   ['rings', 'today', 'list', 'stats', 'trends', 'insights', 'quick']
  };
